...
Luna argues that choosing Must over Should is the only path to a truly fulfilling life — and that it requires real courage, because Must often comes with real uncertainty and real risk.

## Why I include this alongside leadership and technology books

Somewhere in the arc of a long career, most thoughtful people ask whether the work they are doing is the work they are meant to be doing. Luna gives that question a useful frame without the pretension that it has an easy answer.
